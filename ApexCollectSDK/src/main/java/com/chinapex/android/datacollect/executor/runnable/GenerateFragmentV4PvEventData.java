...
public class GenerateFragmentV4PvEventData implements Runnable {
    ...
    public GenerateFragmentV4PvEventData(String pageClassName, String reference, long pvEndTime) {
    ...
    public void run() {
        if (TextUtils.isEmpty(mPageClassName)) {
            ATLog.e(TAG, "GenerateFragmentV4PvEventData run() -> mPageClassName is null or empty!");
            return;
        }
        ...
        valueBean.setReference(TextUtils.isEmpty(mReference) ? "" : mReference);
        ...
        if (null != pvDurationTimes && !TextUtils.isEmpty(mPageClassName)) {
            ...
            if (null != pvStartTime) {
                ...
                ATLog.v(TAG, "GenerateFragmentV4PvEventData run() -> mFragment: " + mPageClassName
