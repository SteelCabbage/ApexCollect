...
public class OkHttpClientManager {
    ...
    public void postJson(String url, String jsonStr, final INetCallback iNetCallback) {
        if (TextUtils.isEmpty(url) || TextUtils.isEmpty(jsonStr)) {
            ATLog.e(TAG, "postJson() -> url or jsonStr is null or empty!");
            return;
        }

        if (null == iNetCallback) {
            ATLog.e(TAG, "postJson() -> iNetCallback is null!");
            return;
        }
        ...
        call.enqueue(new Callback() {
            ...
            public void onResponse(Call call, Response response) throws IOException {
                ...
                if (null == responseBody) {
                    ...
                    ATLog.e(TAG, "postJson onResponse() -> responseBody is null");
                    return;
                }
    ...
    public void postJsonByAuth(String url, String jsonStr, final INetCallback iNetCallback) {
        ...
        call.enqueue(new Callback() {
            ...
            public void onResponse(Call call, Response response) throws IOException {
                ...
                if (null == responseBody) {
                    iNetCallback.onFailed(Constant.NET_BODY_NULL, "NET_BODY_NULL");
                    ATLog.e(TAG, "postJsonByAuth onResponse() -> responseBody is null");
                    return;
                }
    ...
    public void get(String url, final INetCallback iNetCallback) {
        if (TextUtils.isEmpty(url)) {
            ATLog.e(TAG, "get() -> url is null!");
            return;
        }

        if (null == iNetCallback) {
            ATLog.e(TAG, "get() -> iNetCallback is null!");
            return;
        }
        ...
        call.enqueue(new Callback() {
            ...
            public void onResponse(Call call, Response response) throws IOException {
                ...
                if (null == responseBody) {
                    iNetCallback.onFailed(Constant.NET_BODY_NULL, "NET_BODY_NULL");
                    ATLog.e(TAG, "get onResponse() -> responseBody is null");
                    return;
                }
